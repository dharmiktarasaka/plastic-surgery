...
export default function BodyProceduresPage() {
  const category = procedureCategories.find(c => c.id === 'body') || procedureCategories[2];

  return (
    <SubpageLayout>
      <Helmet>
        <title>Body Contouring & VASER Liposuction | TARASAKA Centre</title>
        <meta name="description" content="HD VASER liposuction, abdominoplasty tummy tuck, and mommy makeover body sculpting with ultrasound tissue preservation." />
      </Helmet>
          ...
          {category.procedures.map((proc) => (
            ...
            >
              <div className="lg:col-span-7 space-y-4">
                ...
                <div>
                  <h4 className="text-xs font-mono font-bold uppercase text-[#3A243F] mb-2">Key Highlights:</h4>
              ...
              <div className="lg:col-span-5 p-6 rounded-2xl bg-[#FFF9F8] border border-[#FFE2E2] flex flex-col justify-between h-full">
                <div>
                  <h4 className="text-xs font-mono font-bold uppercase text-[#3A243F] mb-2">Candidate Evaluation:</h4>
                ...
                >
                  Schedule Body Contouring Assessment
                </Link>
              </div>
            </div>
          ))}
